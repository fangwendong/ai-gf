...
assert.match(html, /v1\.0 Mouse VN/, "visible version badge exists");
...
assert.match(css, /\.scene-hud/, "scene hud exists");
...
assert.match(sw, /ai-gf-v12/, "service worker cache version is current");
